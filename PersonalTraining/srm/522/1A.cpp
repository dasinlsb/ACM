/*
假设两端至少有1个A，肯定是先手必胜，下面考虑两端都是B的情况
讨论一下发现Alice不能使任意一端是单个B，否则Bob后手选完另一端就结束了
那么Alice先手留下最优只可能使BXXX...XXXB
这样的话，Bob后手可以从将任一端取到只剩下一个B，这样的话下一手Alice怎么取都会输
*/
...
class RowAndCoins {
	...
	string getWinner(string cells)  {  
		// $CARETPOSITION$  
    return (cells[0]=='A'||cells.back()=='A')?"Alice":"Bob";
	}  
